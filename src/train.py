...
df = pd.read_csv(os.path.join(BASE_DIR, "data", "raw", "application_train.csv"))
...
joblib.dump(X_test, os.path.join(BASE_DIR, "data", "processed", "X_test.joblib"))
joblib.dump(y_test, os.path.join(BASE_DIR, "data", "processed", "y_test.joblib"))
...
for model_name, model in models.items():
    ...
    joblib.dump(pipeline, os.path.join(BASE_DIR, "models", f"{model_name}.joblib"))
