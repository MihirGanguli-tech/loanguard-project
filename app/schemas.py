...
class LoanApplication(BaseModel):
    '''
    Schema to handle incoming loan application data.
    All the original features of the dataset before any preprocessing.
    All columns below are optional as real data will have missing fields, the preprocessing pipeline handles this later in the pipeline.
    '''
...
class PredictionResponse(BaseModel):
    ...
    Returns the binary default prediction, the model's estimated probability
    of default, and an additional 'risk level' for interpretability.
    """
